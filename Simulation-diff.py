# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 15:14:18 2021
...
plt.ylabel('Computation time difference', fontsize=8)
plt.plot(x,y,'-', color='blue', label='Time difference between Kuhn-Munkres and Hybrid algorithm') 
plt.plot(a,b,'-', color='red', label='Line of the same computation time')
