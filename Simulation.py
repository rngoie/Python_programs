...
plt.ylabel('Rate of optimal solutions', fontsize=8)
plt.plot(x,y,'-', color='blue', label='Hybrid greedy algorithm performance')
plt.plot(a,b,'-', color='red', label='Kuhn-Munkres performance (100 %)')
